...
namespace AmericaShop.Api.Data
{
    public class AmericaShopDbContext:DbContext
    {
        public AmericaShopDbContext(DbContextOptions<AmericaShopDbContext> options):base(options)
        {
